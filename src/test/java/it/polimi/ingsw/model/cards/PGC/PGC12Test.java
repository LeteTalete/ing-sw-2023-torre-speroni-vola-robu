...
public class PGC12Test {
    ...
    public void scoreTest() {
        ...
        player.setGoalCard(12);
        assertEquals(12, player.getGoalCard().getNumPGC());

        assertEquals("2:B", player.getGoalCard().getPositionTilePC().get(0));
        assertEquals("1:P", player.getGoalCard().getPositionTilePC().get(1));
        assertEquals("2:F", player.getGoalCard().getPositionTilePC().get(2));
        assertEquals("3:T", player.getGoalCard().getPositionTilePC().get(3));
        assertEquals("4:G", player.getGoalCard().getPositionTilePC().get(4));
        assertEquals("0:C", player.getGoalCard().getPositionTilePC().get(5));
