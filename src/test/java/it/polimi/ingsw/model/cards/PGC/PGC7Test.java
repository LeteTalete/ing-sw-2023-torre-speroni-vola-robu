...
public class PGC7Test {
    ...
    public void scoreTest() {
        ...
        player.setGoalCard(7);
        assertEquals(7, player.getGoalCard().getNumPGC());

        assertEquals("0:C", player.getGoalCard().getPositionTilePC().get(0));
        assertEquals("3:F", player.getGoalCard().getPositionTilePC().get(1));
        assertEquals("1:P", player.getGoalCard().getPositionTilePC().get(2));
        assertEquals("0:T", player.getGoalCard().getPositionTilePC().get(3));
        assertEquals("4:G", player.getGoalCard().getPositionTilePC().get(4));
        assertEquals("2:B", player.getGoalCard().getPositionTilePC().get(5));
