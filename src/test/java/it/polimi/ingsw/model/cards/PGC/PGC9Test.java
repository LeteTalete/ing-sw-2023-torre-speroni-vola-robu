...
public class PGC9Test {
    ...
    public void scoreTest() {
        ...
        player.setGoalCard(9);
        assertEquals(9, player.getGoalCard().getNumPGC());

        assertEquals("2:G", player.getGoalCard().getPositionTilePC().get(0));
        assertEquals("-", player.getGoalCard().getPositionTilePC().get(1));
        assertEquals("2:C", player.getGoalCard().getPositionTilePC().get(2));
        assertEquals("4:B", player.getGoalCard().getPositionTilePC().get(3));
        assertEquals("1:T:4:P", player.getGoalCard().getPositionTilePC().get(4));
        assertEquals("0:F", player.getGoalCard().getPositionTilePC().get(5));
