...
public class PGC5Test {
    ...
    public void scoreTest() {
        ...
        player.setGoalCard(5);

        assertEquals(5, player.getGoalCard().getNumPGC());

        assertEquals("-", player.getGoalCard().getPositionTilePC().get(0));
        assertEquals("1:T", player.getGoalCard().getPositionTilePC().get(1));
        assertEquals("-", player.getGoalCard().getPositionTilePC().get(2));
        assertEquals("1:F:2:B", player.getGoalCard().getPositionTilePC().get(3));
        assertEquals("4:P", player.getGoalCard().getPositionTilePC().get(4));
        assertEquals("0:G:3:C", player.getGoalCard().getPositionTilePC().get(5));
