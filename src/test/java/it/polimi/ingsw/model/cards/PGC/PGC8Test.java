...
public class PGC8Test {
    ...
    public void scoreTest() {
        ...
        player.setGoalCard(8);
        assertEquals(8, player.getGoalCard().getNumPGC());

        assertEquals("4:F", player.getGoalCard().getPositionTilePC().get(0));
        assertEquals("1:C", player.getGoalCard().getPositionTilePC().get(1));
        assertEquals("2:T", player.getGoalCard().getPositionTilePC().get(2));
        assertEquals("0:P", player.getGoalCard().getPositionTilePC().get(3));
        assertEquals("3:B", player.getGoalCard().getPositionTilePC().get(4));
        assertEquals("3:G", player.getGoalCard().getPositionTilePC().get(5));
