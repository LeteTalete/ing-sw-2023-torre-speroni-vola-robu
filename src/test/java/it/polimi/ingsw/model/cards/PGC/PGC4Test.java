...
public class PGC4Test {
    ...
    public void scoreTest() {
        ...
        player.setGoalCard(4);
        assertEquals(4, player.getGoalCard().getNumPGC());

        assertEquals("4:G", player.getGoalCard().getPositionTilePC().get(0));
        assertEquals("-", player.getGoalCard().getPositionTilePC().get(1));
        assertEquals("0:T:2:F", player.getGoalCard().getPositionTilePC().get(2));
        assertEquals("3:P", player.getGoalCard().getPositionTilePC().get(3));
        assertEquals("1:B:2:C", player.getGoalCard().getPositionTilePC().get(4));
        assertEquals("-", player.getGoalCard().getPositionTilePC().get(5));
