...
public class PGC3Test {
    ...
    public void scoreTest() {
        ...
        player.setGoalCard(3);
        assertEquals(3, player.getGoalCard().getNumPGC());

        assertEquals("-", player.getGoalCard().getPositionTilePC().get(0));
        assertEquals("0:F:3:G", player.getGoalCard().getPositionTilePC().get(1));
        assertEquals("2:P", player.getGoalCard().getPositionTilePC().get(2));
        assertEquals("1:C:4:T", player.getGoalCard().getPositionTilePC().get(3));
        assertEquals("-", player.getGoalCard().getPositionTilePC().get(4));
        assertEquals("0:B", player.getGoalCard().getPositionTilePC().get(5));
