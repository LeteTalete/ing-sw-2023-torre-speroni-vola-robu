...
public class PGC11Test {
    ...
    public void scoreTest() {
        ...
        player.setGoalCard(11);
        assertEquals(11, player.getGoalCard().getNumPGC());

        assertEquals("2:P", player.getGoalCard().getPositionTilePC().get(0));
        assertEquals("1:B", player.getGoalCard().getPositionTilePC().get(1));
        assertEquals("0:G", player.getGoalCard().getPositionTilePC().get(2));
        assertEquals("2:F", player.getGoalCard().getPositionTilePC().get(3));
        assertEquals("4:C", player.getGoalCard().getPositionTilePC().get(4));
        assertEquals("3:T", player.getGoalCard().getPositionTilePC().get(5));
