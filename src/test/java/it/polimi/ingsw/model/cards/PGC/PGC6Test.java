...
public class PGC6Test {
    ...
    public void scoreTest() {
        ...
        player.setGoalCard(6);
        assertEquals(6, player.getGoalCard().getNumPGC());

        assertEquals("2:T:4:C", player.getGoalCard().getPositionTilePC().get(0));
        assertEquals("-", player.getGoalCard().getPositionTilePC().get(1));
        assertEquals("3:B", player.getGoalCard().getPositionTilePC().get(2));
        assertEquals("-", player.getGoalCard().getPositionTilePC().get(3));
        assertEquals("1:G:3:F", player.getGoalCard().getPositionTilePC().get(4));
        assertEquals("0:P", player.getGoalCard().getPositionTilePC().get(5));
