...
public class PGC10Test {
    ...
    public void scoreTest() {
        ...
        player.setGoalCard(10);
        assertEquals(10, player.getGoalCard().getNumPGC());

        assertEquals("4:T", player.getGoalCard().getPositionTilePC().get(0));
        assertEquals("1:G", player.getGoalCard().getPositionTilePC().get(1));
        assertEquals("0:B", player.getGoalCard().getPositionTilePC().get(2));
        assertEquals("3:C", player.getGoalCard().getPositionTilePC().get(3));
        assertEquals("1:F", player.getGoalCard().getPositionTilePC().get(4));
        assertEquals("3:P", player.getGoalCard().getPositionTilePC().get(5));
