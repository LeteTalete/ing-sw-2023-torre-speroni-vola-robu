...
public class PGC2Test {
    ...
    public void scoreTest() {
        ...
        player.setGoalCard(2);
        assertEquals(2, player.getGoalCard().getNumPGC());

        assertEquals("-", player.getGoalCard().getPositionTilePC().get(0));
        assertEquals("1:P", player.getGoalCard().getPositionTilePC().get(1));
        assertEquals("0:C:2:G", player.getGoalCard().getPositionTilePC().get(2));
        assertEquals("4:B", player.getGoalCard().getPositionTilePC().get(3));
        assertEquals("3:T", player.getGoalCard().getPositionTilePC().get(4));
        assertEquals("4:F", player.getGoalCard().getPositionTilePC().get(5));
